...
export default function RecentCard({ cover, id, name, platforms, genres, rating }) {
  ...
  return (
    <div className='bg-darker-grey tablet:my-0  my-8 tablet:h-96 h-96 laptop:w-600 tablet:w-128 w-full rounded-lg drop-shadow-md flex justify-around hover:scale-101 hover:drop-shadow-lg transition-all duration-300 ease-linear'>
