      ...
      <div className="border-t border-slate-900/5 py-10">
        ...
        <div className="mt-5 flex items-center justify-center space-x-4 text-sm font-semibold">
          ...
          <div className='grid grid-rows-2'>
            <a href="https://www.instagram.com/sbsgabriel/" target="_blank" className='mobile:text-lg text-sm  transition-all duration-300 ease-linear hover:text-wierdo-orange'>Gabriel </a>
            <BsInstagram className='text-wierdo-orange mobile:w-5 w-3 h-auto my-1 mx-auto' />
          </div>

          <div className="h-4 w-px bg-not-white"></div>

          <div className='grid grid-rows-2'>
            <a href="https://www.instagram.com/nicolas_m.g1/" target="_blank" className='mobile:text-lg text-sm transition-all duration-300 ease-linear hover:text-wierdo-orange'>Nicolas</a>
            <BsInstagram className='text-wierdo-orange mobile:w-5 w-3 h-auto my-1 mx-auto' />
          </div>
