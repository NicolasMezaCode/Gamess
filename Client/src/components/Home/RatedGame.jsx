...
const formatedRating=stars.toFixed(1)
  return (
    <div className='mt-3'>
      <Link to={`/game/${id}`}>
        <figure className='ml-9 mr-9 '><img className='rounded-md opacity-80 hover:opacity-100 transition-all duration-300 ease-linear' src={image} alt="cover of the games" />
